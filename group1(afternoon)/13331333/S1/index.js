...
function disable_buttons(i, buttons) {
...
window.onload = function() {
    ...
    var button = getByClass(document, "icon");
    button[0].addEventListener("transitionend", function() {  // to add a listener to the icon's transition
        for (var i = 0; i < buttons.length; ++i) {
